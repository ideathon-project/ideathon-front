(function($) {
        ...
        $this.submit(function() {
            ...
            $.ajax({
                ...
                success: function success(data) {
                    ...
                    if (data.error == true) {
                        $('.form-result', $this).addClass('alert-warning').removeClass('alert-success alert-danger').fadeIn(150).show().delay(2000).fadeOut(150);
                    } else {
                        $('.form-result', $this).addClass('alert-success').removeClass('alert-warning alert-danger').fadeIn(150).show().delay(2000).fadeOut(150);
                    }
    ...
    $(function() {
        ...
        if (eventCounter.length) {
            eventCounter.countdown("2022/12/31", function(e) {
                $(this).html(
                    e.strftime(
