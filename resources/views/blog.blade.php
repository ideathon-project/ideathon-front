                    ...
                    <div class="col-lg-8">
                     <!-- BLOG BAŞLANGIÇ -->
                        <article class="blog-meta-three tran3s mt-45">
                            <figure class="post-img m0"><a href="/" class="w-100 d-block"><img src="https://api.hackathonturkiye.com/media/hosting/images/1_WBhoIYUpYuv4f3xrj2Palw.png" alt="" class="w-100 tran4s"></a></figure>
                            <div class="post-data">
